...
PRESETS: dict[PresetId, dict[str, Any]] = {
    ...
    PresetId.KT_CG_TRIAL_9: {
        "name": "KT/CG Trial #9 (NTZ + Kill Switch)",
        "description": "Trial #9: T8 entries + No-Trade Zones (PDH/L, WH/L, MH/L) + Kill Switch (M1-200 EMA exit for tiers 17/21/27). No broker SL. TP1 partial + BE + M1 21-EMA bar-close trail.",
        "pros": [
            "No-Trade Zones block entries near major liquidity levels",
            "Kill Switch auto-exits short tiers when M1 close crosses 200 EMA",
            "Bar-close-only trail reduces whipsaws vs tick-based trail",
            "Deep tiers (33-100) held through pullbacks for larger moves",
        ],
        "cons": [
            "No broker SL — tiers 33-100 require manual risk management",
            "Kill Switch may exit early in volatile but trending conditions",
            "NTZ may block valid entries if buffer is set too wide",
        ],
        "risk": {
            "max_lots": 0.1,
            "require_stop": False,
