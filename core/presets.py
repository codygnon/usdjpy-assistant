...
PRESETS: dict[PresetId, dict[str, Any]] = {
    ...
    PresetId.KT_CG_TRIAL_10: {
        ...
        "description": "Trial #10: Trial #9 upgraded with fresh EMA-cross zone entries, tier reclaim confirmation, NTZ + intraday fib corridor on by default, conviction sizing, and tighter caps.",
        "pros": [
            "Fresh zone entries require a recent M1 EMA 5/9 cross in the M5 trend direction",
            "Tier entries require touch then reclaim, filtering raw EMA taps",
            "Deepest pullback tier is reserved for strong M5 regimes",
            "Sloppy shallow pullbacks are automatically size-dampened instead of blocked outright",
            "NTZ, conviction sizing, and M15 fib corridor are enabled by default",
            "Lower caps focus exposure on cleaner continuation setups",
        ],
        "cons": [
            "Stricter confirmation will reduce total trade count",
            "More moving parts than Trial #8",
            "Still needs paper-trade validation against the day-trading presets",
        ],
        "risk": {
            "max_lots": 0.1,
            "require_stop": True,
            ...
            "policies": [
                {
                    ...
                    "zone_entry_require_recent_cross": True,
                    "zone_entry_max_cross_lookback_bars": 2,
                    "tiered_pullback_enabled": True,
                    "tier_ema_periods": [17, 21, 27, 33, 50],
                    "tier_reset_buffer_pips": 1.0,
                    "tier_reclaim_confirmation_enabled": True,
                    "tier_reclaim_ema_period": 5,
                    "strong_m5_only_tier_periods": [50],
                    ...
                    "regime_london_sell_veto": True,
                    "regime_london_start_hour_et": 3,
                    "regime_london_end_hour_et": 12,
                    "regime_boost_hours_et": [6, 7, 12, 13, 14, 15],
                    "regime_boost_multiplier": 1.35,
                    "regime_buy_base_multiplier": 0.65,
                    "regime_sell_base_multiplier": 0.35,
                    ...
                    "trend_exhaustion_tp_very_extended_offset_pips": 2.0,
                    "trend_exhaustion_tp_min_pips": 1.0,
                    "max_open_trades_per_side": 3,
                    "max_zone_entry_open": 1,
                    "max_tiered_pullback_open": 2,
                },
            ],
        },
    },
