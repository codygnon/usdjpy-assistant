...
PRESETS: dict[PresetId, dict[str, Any]] = {
    ...
    PresetId.UNCLE_PARSH_H1_BREAKOUT: {
        ...
        "description": "Level-based scalping: H1 S/R detection -> M5 Power Close + velocity -> M1 surgical entry. Scale-out 50% at TP1, trail runner on M1 21 EMA.",
        "pros": [
            ...
            "policies": [
                {
                    ...
                    "m5_trend_ema_fast": 9,
                    "m5_trend_ema_slow": 21,
                    "power_close_body_pct": 0.25,
                    "velocity_pips": 5.0,
                    "m1_ema_fast": 5,
                    "m1_ema_mid": 9,
                    "m1_ema_slow": 21,
                    "m1_ema_veto": 35,
                    "m1_ema_veto_enabled": True,
                    "m1_ema_veto_buffer_pips": 2.0,
                    "m1_entry_stack_mode": "full",
                    "initial_sl_spread_plus_pips": 2.0,
                    "tp1_pips": 6.0,
                    "tp1_close_pct": 50.0,
                    "be_spread_plus_pips": 2.0,
                    "trail_ema_period": 21,
