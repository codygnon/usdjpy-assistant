...
PRESETS: dict[PresetId, dict[str, Any]] = {
    ...
    PresetId.KT_CG_TRIAL_10: {
        ...
        "description": "Trial #10: Runner-score sizing replaces conviction sizing. Sizes UP on elite/press setups, DOWN on floor/base. Fib corridor disabled. TP1 re-arms tiers for trend continuation.",
        "pros": [
            "Runner-score sizing puts 13x more size on elite vs floor setups",
            "TP1 tier reset enables repeated entries in flowing trends",
            "Aggressive zone entry matches T8/T9 frequency in trends",
            "Spread gate and tier17 floor protect against bad entries",
            "NTZ, regime gate, chop pause all still active",
        ],
        "cons": [
            "Higher max_lots requires careful account sizing",
            "More frequent entries in trends — monitor total exposure",
            "Still needs live validation of runner-score lot ladder",
        ],
        "risk": {
            "max_lots": 0.50,
            "require_stop": True,
