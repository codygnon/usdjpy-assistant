#!/usr/bin/env python3
"""Run Swing-Macro strategy backtest with zero spread (cost-free diagnostic)."""
...
from run_swing_macro_real import (
...
def main() -> None:
    ...
    output_dir = ROOT / "research_out/swing_macro_zero"
    ...
    ext["methodology_notes"] = "Near-zero spread (1e-6 pip), zero slippage. Cost-free diagnostic."
