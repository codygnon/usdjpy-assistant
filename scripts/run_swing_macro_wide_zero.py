#!/usr/bin/env python3
"""Run Swing-Macro WIDE-STOP backtest with near-zero spread (diagnostic)."""
...
from run_swing_macro_wide_real import (
...
def main() -> None:
    ...
    output_dir = ROOT / "research_out/swing_macro_wide_zero"
    ...
    log("=== SWING-MACRO WIDE STOPS — ZERO SPREAD (2.5× ATR stop, 1.0× trail buffer) ===")
    ...
    cfg = RunConfig(
        hypothesis="swing_macro_wide_zero",
        data_path=uj_path,
    ...
    ext["methodology_notes"] = (
        "WIDE: atr_stop_factor=2.5, trail_buffer_atr=1.0. Near-zero spread, zero slippage."
    )
