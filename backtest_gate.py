    ...
    with patched_historical_clock():
        for idx in range(len(frames["M1"])):
            ...
            wake: dict[str, Any] = {
                ...
                "session_range_pips": extras.get("session_range_pips"),
                "session_mid_price": extras.get("session_mid_price"),
                "reward_to_mid_pips": extras.get("reward_to_mid_pips"),
                "bb_width": extras.get("bb_width"),
